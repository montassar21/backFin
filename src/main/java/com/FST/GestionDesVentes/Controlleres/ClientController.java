...
public class ClientController {
	 ...
	 * public ResponseEntity<String> addPaiementToClient(@PathVariable Long
	 * clientId, @PathVariable Long paiementId) {
	 * Client client = clientrepository.findById(clientId).orElse(null);
	 ...
	 * body("Client or Paiement not found");
	 * }
	 * 
	 ...
	 * public ResponseEntity<Client> removePaiementFromClient(@PathVariable Long
	 * clientId, @PathVariable Long paiementId) {
	 * Client client = clientrepository.findById(clientId).orElse(null);
	 * Paiement paiement = paiementRepository.findById(paiementId).orElse(null);
	 * 
