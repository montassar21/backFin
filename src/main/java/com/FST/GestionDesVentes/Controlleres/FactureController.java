...
public class FactureController {
	...
	@PostMapping("/add")
	public ResponseEntity<String> creerFacture(@RequestParam Long commandeId, @RequestParam PaiementType paiementType,
			@RequestParam FacilitePaiement facilitePaiement) {
